        ...
        "list_checks" => {
            let checks = json!({
                "checks": [
                    ...
                    {"id": "repr-c-field-count", "severity": "error",
                     "desc": "#[repr(C)] struct field count mismatch with C header"},
                    {"id": "repr-c-field-order", "severity": "error",
                     "desc": "#[repr(C)] fields same names but wrong order — silent memory corruption!"},
                    {"id": "repr-c-field-names", "severity": "warning",
                     "desc": "#[repr(C)] field names partially mismatch C header"},
                    {"id": "repr-c-unknown-ctype", "severity": "warning",
                     "desc": "C struct field type not recognized — verify FFI mapping"},
                    {"id": "repr-c-no-c-match", "severity": "warning",
                     "desc": "#[repr(C)] struct has no matching C header definition"},
                    {"id": "repr-c-unused-cstruct", "severity": "info",
                     "desc": "C header struct has no #[repr(C)] Rust counterpart"},
